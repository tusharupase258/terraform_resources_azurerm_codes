terraform {
  ...
  # Uncomment the following backend configuration and replace the placeholder values if you wish to use an Azure Storage backend for Terraform state.
  #
  # backend "azurerm" {
...
provider "azurerm" {
  features {}  # Use feature block to enable basic functionality
}
